  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
      ...
      array(
        ...
        array(
            'id'          => 'themo_portfolio',
            'title'       => __( 'Portfolio', THEMO_TEXT_DOMAIN ),
        ),
      /*array(
        'id'          => 'meta_stuff',
    ...
    'settings'        => array( 
	  ...
	  array(
	   ...
	   array(
        ...
        array(
            'id'          => 'themo_preloader',
            'label'       => __( 'Content Preloader', THEMO_TEXT_DOMAIN ),
            'std'         => 'on',
            'type'        => 'on-off',
            'section'     => 'themo_general',
            'rows'        => '',
      ...
      array(
          ...
          'label'       => __( 'Demo Font Settings', THEMO_TEXT_DOMAIN ),
          'desc'        => 	sprintf(__('Documentation: %1$s%2$sPhysician%7$s | %1$s%3$sContractor%7$s | %1$s%4$sConsultant%7$s | %1$s%5$sCoach%7$s | %1$s%6$sTrainer%7$s   ', THEMO_TEXT_DOMAIN), '<a target="_blank" href=http://docs.themovation.com/entrepreneur/','#fonts_physician>','#fonts_contractor>','#fonts_consultant>','#fonts_coach>','#fonts_trainer>','</a>') ,
          'std'         => '',
      ...
      array(
        ...
        array(
            ...
            'label'       => __( 'Paging Control', THEMO_TEXT_DOMAIN ),
            'desc'        => __( 'Create navigation for paging control of each slide.', THEMO_TEXT_DOMAIN ),
            'std'         => 'on',
            'type'        => 'on-off',
            'section'     => 'themo_slider_config',
            'rows'        => '',
        ...
        array(
            ...
            'label'       => __( 'Portfolio Home', THEMO_TEXT_DOMAIN ),
            'desc'        => __( 'Choose your portfolio home page.', THEMO_TEXT_DOMAIN ),
            'std'         => '',
            'type'        => 'page_select',
        ...
        array(
            ...
            'label'       => __( 'Portfolio Home Anchor Link', THEMO_TEXT_DOMAIN ),
            'type'        => 'text',
            'section'     => 'themo_portfolio',
            'desc'        => __( 'e.g. #schedule will be appended to home link selected above', THEMO_TEXT_DOMAIN ),
        ),
        array(
            'id'          => 'themo_portfolio_rewrite_slug',
            'label'       => __( 'Portfolio Custom Slug', THEMO_TEXT_DOMAIN ),
            'type'        => 'text',
            'section'     => 'themo_portfolio',
        ),
        array(
            'id'          => 'themo_project_addthis_toolbox',
            'label'       => __( 'Project AddThis Toolbox', THEMO_TEXT_DOMAIN ),
            'desc'        => __( 'Enable AddThis Toolbox for projects.', THEMO_TEXT_DOMAIN ),
            'std'         => 'on',
            'type'        => 'on-off',
            'section'     => 'themo_portfolio',
        ),
        array(
            ...
            'label'       => __( 'Project Icons', THEMO_TEXT_DOMAIN ),
            'desc'        => __( 'Turn Project Icons on or off globally', THEMO_TEXT_DOMAIN ),
            'std'         => 'on',
            'type'        => 'on-off',
            'section'     => 'themo_portfolio',
            'rows'        => '',
        ...
        array(
            ...
            'label'       => __( 'Project Navigation Control', THEMO_TEXT_DOMAIN ),
            'desc'        => __( 'Turn prev / next links on or off', THEMO_TEXT_DOMAIN ),
            'std'         => 'on',
            'type'        => 'on-off',
            'section'     => 'themo_portfolio',
            'rows'        => '',
