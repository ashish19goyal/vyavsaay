...
function themo_return_icons($key,$i,$class=''){
    ...
    $glyphicons_icon = array(
        ...
        'name'       => 'Icon Key',
        'desc'        => 'Use any <a href="'.$glyphicons_website.'" target="_blank">Glyphicon</a> (e.g.: social-facebook). <a href="'.$glyphicons_website.'" target="_blank">FULL LIST HERE</a>',
        'type'        => 'text',
        'class' => $class
    );
...
function themo_return_meta_header($key,$i){
    ...
    return array($show_header,$header,$subtext,$header_float);
}
...
// Button
//-----------------------------------------------------
function themo_return_button_options($key,$i,$tab=null){
    ...
    $button_text 	= array(
        ...
        'name'       =>  'Button Text',
        'type'        => 'text',
        'class' => 'checkbox-condition '.$key."_".$i.'_show_button',
        'tab'  =>  $tab,
    );
    $button_link 	= array(
...
function _themo_general_meta_boxes($meta_boxes) {
    ...
    /* Get Button Options */
    list($show_button,$button_text,$button_link,$button_style,$button_link_target) = themo_return_button_options($key,$i);
    ...
    /* Get Button Options */
    list($show_button,$button_text,$button_link,$button_style,$button_link_target) = themo_return_button_options($key,$i,'button');
...
//-----------------------------------------------------
    ...
    /* Header */
    list($show_header,$header,$subtext,$header_float) = themo_return_meta_header($key,$i);
    ...
    /* Get Button Options */
    list($show_button,$button_text,$button_link,$button_style,$button_link_target) = themo_return_button_options($key,$i,'header');
    ...
    $themo_page_header_meta = array(
        ...
        'fields'      => array(
            ...
            $show_header,$header,$subtext,$header_float,
