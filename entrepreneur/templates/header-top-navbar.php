...
if ( function_exists( 'ot_get_option' ) ) {
	...
	if(isset($transparent_header) && !empty( $transparent_header ) && $transparent_header == 'on' && ($slider || $page_header) && $disable_nav_transparency !== '1')
	{
		$transparency = true;
...
<header class="banner navbar navbar-default navbar-static-top" role="banner" <?php echo sanitize_text_field($transparent_header);?>>
	<div class="container">
