				...
				echo '<div class="float-content '.$bootstrap_tier_content.'">';
					echo '<div class="center-table-con">';
						echo '<div class="center-table-cell">';
							...
							if ($button > "") {
								//$button_markup = '<p class="accordion-btn">' . do_shortcode($button) . '</p>';
								echo '<div class="tour-button-', $i, themo_return_entrance_animation_class($themo_enable_animate,$themo_animation_style,'#'.$section_uid.' .tour-button-'.$i),'">', do_shortcode($button) , '</div>';
