<div id='projects_main' class='vy_tabs function_main'>
		...
		<ul>
			...
			<li><a id='form135_link' href='#form135' onclick='form135_header_ini(); form135_ini();' data-i18n='form.project_dashboard'></a></li>
			...
			<li><a id='form104_link' href='#form104' onclick='form104_header_ini(); form104_ini();' data-i18n='form.project_tasks'></a></li>
			...
			<li><a id='form139_link' href='#form139' onclick='form139_header_ini(); form139_ini();' data-i18n='form.customer_profiling'></a></li>
			<li><a id='form140_link' href='#form140' onclick='form140_header_ini(); form140_ini();' data-i18n='form.supplier_profiling'></a></li>
		</ul>
