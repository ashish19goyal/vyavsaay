<div id='admin_main' class='function_main'>
	<?php 
		...
		echo "<ul>";
			...
			if(strpos($_SESSION['forms'],'form123-')!==false)
				echo "<li><a id='form123_link' href='#form123' onclick='form123_header_ini(); form123_ini();' data-i18n='form.mandatory_attributes'></a></li>";
		echo "</ul>";
