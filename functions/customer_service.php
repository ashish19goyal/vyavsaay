<div id='customer_service_main' class='vy_tabs function_main'>		
		<ul>
			<li><a id='form128_link' href='#form128' onclick='form128_header_ini(); form128_ini();' data-i18n='form.manage_requests'></a></li>
			<li><a id='form134_link' href='#form134' onclick='form134_header_ini(); form134_ini();' data-i18n='form.request_detail'></a></li>
			<li><a id='form151_link' href='#form151' onclick='form151_header_ini(); form151_ini();' data-i18n='form.billing'></a></li>
