<div id='people_main' class='vy_tabs function_main'>		
		<ul>
			...
			<li><a id='form96_link' href='#form96' onclick='form96_header_ini(); form96_ini();' data-i18n='form.customer_attributes'></a></li>
