<div id='logistics_main' class='vy_tabs function_main'>
		<ul>
			<li><a id='form199_link' href='#form199' onclick='form199_header_ini(); form199_ini();' data-i18n='form.incoming_items'></a></li>
			...
			<li><a id='form204_link' href='#form204' onclick='form204_header_ini(); form204_ini();' data-i18n='form.pending_orders'></a></li>
			<li><a id='form205_link' href='#form205' onclick='form205_header_ini(); form205_ini();' data-i18n='form.undelivered_orders'></a></li>
			<li><a id='form206_link' href='#form206' onclick='form206_header_ini(); form206_ini();' data-i18n='form.delivered_orders'></a></li>
