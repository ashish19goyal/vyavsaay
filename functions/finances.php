<div id='finances_main' class='vy_tabs function_main'>
		...
		<ul>
			...
			<li><a id='form271_link' href='#form271' onclick='form271_header_ini(); form271_ini();' data-i18n='form.enter_cod_collection'></a></li>
			<li><a id='report96_link' href='#report96' onclick='report96_header_ini();' data-i18n='form.collection_report'></a></li>
		</ul>
	...
	<?php 
			...
			include "forms/form271.php";
			include "reports/report96.php";
	?>		
