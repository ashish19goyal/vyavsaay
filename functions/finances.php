	...
	<?php 
		...
		echo "<ul>";
			...
			if(strpos($_SESSION['forms'],'form56')!==false)
				echo "<li><a id='form56_link' href='#form56' onclick='form56_header_ini(); form56_ini();' data-i18n='form.expense_register'></a></li>";			
			if(strpos($_SESSION['reports'],'report14')!==false)
				echo "<li><a id='report14_link' href='#report14' onclick='report14_header_ini(); report14_ini();' data-i18n='form.expenses_by_period'></a></li>";
			...
			if(strpos($_SESSION['reports'],'report6')!==false)
				echo "<li><a id='report6_link' href='#report6' onclick='report6_header_ini(); report6_ini();' data-i18n='form.payments_due'></a></li>";
			if(strpos($_SESSION['forms'],'form71')!==false)
				echo "<li><a id='form71_link' href='#form71' onclick='form71_header_ini(); form71_ini();' data-i18n='manage accounts'></a></li>";
		echo "</ul>";
