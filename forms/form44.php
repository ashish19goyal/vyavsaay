		...
		<thead>
			<tr>
				<form id='form44_header'></form>
					<th>Pamphlet Name <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form44_header' onblur="form44_ini('');"></th>
