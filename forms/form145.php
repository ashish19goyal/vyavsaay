<div id='form145' class='function_detail'>
	<table class='rwd-table'>
		<thead>
			<tr>
				<form id='form145_header'></form>
					<th>Product <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form145_header'></th>
