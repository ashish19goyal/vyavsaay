		...
		<div class="actions">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a id='form312_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
                    </li>
                    <li>
                      	<a id='form312_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
                    </li>
                    <li>
                        <a id='form312_print'><i class='fa fa-print'></i> Print</a>
                    </li>
                </ul>
            </div>
        </div>
	...
	<script>
		...
		function form312_ini()
		{
			...
			read_json_rows('form312',overwrite_data,function(results)
			{
				...
				vExport.export_buttons({action:'dynamic',columns:overwrite_data,file:'Newsletter Components',report_id:'form312'});
				hide_loader();
			});
		};
