		...
		<thead>
			<tr>
				<form id='form40_header'></form>
					<th>Supplier Name <img src='../images/filter.jpeg' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form40_header' onblur="form40_ini('');"></th>
					...
					<th>Address</th>
					<th>Notes</th>
					<th><input type='button' form='form40_header' value='Add new supplier' class='add_icon' onclick='form40_add_item();'>
