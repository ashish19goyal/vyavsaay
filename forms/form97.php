<div id='form97' class='function_detail'>
	<table class='rwd-table'>
		<thead>
			<tr>
				<form id='form97_header'></form>
					<th>Name <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form97_header' onblur="form97_ini();"></th>
					<th>Attribute <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form97_header' onblur="form97_ini();"></th>
					<th>Value</th>
					<th><input type="button" value='Add new category' form='form97_header' class='add_icon' onclick="form97_add_item();">
						...
						<input type='button' form='form97_header' value='IMPORT' class='import_icon'>
					</th>
			</tr>
		</thead>
