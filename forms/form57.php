		...
		<thead>
			<tr>
				<form id='form57_header'></form>
					...
					<th>Description </th>
					<th>Warranty </th>
					<th>Tags <img src='../images/filter.jpeg' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form57_header' onblur="form57_ini('');"></th>
					<th>Price</th>
					<th>Duration</th>
					<th><input type="button" value='Add new service' form='form57_header' onclick="modal20_action();"></th>
			</tr>
		</thead>
