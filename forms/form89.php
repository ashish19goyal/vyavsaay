		...
		<thead>
			<tr>
				<form id='form89_header'></form>
					<th>Customer <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form89_header' onblur="form89_ini();"></th>
					<th>Assignee <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form89_header' onblur="form89_ini();"></th>
					<th>Schedule</th>
					<th>Notes</th>
					<th>Status <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form89_header' onblur="form89_ini();"></th>
