		...
		<div class="actions">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a id='form123_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
                    </li>
                    <li>
                      	<a id='form123_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
                    </li>
                    <li>
                        <a id='form123_print'><i class='fa fa-print'></i> Print</a>
                    </li>
                    <li class="divider"> </li>
                    <li>
                        <a id='form123_upload' onclick=modal23_action(form123_import_template,form123_import,form123_import_validate);><i class='fa fa-upload'></i> Import</a>
                    </li>
                </ul>
            </div>
        </div>
	...
	<script>
		...
		function form123_ini()
		{
			...
			read_json_rows('form123',data_json,function(results)
			{
				...
				vExport.export_buttons({action:'dynamic',columns:data_json,file:'Mandatory Attributes',report_id:'form123'});
				hide_loader();
			});
		};
