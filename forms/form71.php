		...
		<thead>
			<tr>
				<form id='form71_header'></form>
					<th>Type <img src='../images/filter.jpeg' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form71_header' onblur="form71_ini();"></th>
					<th>Name <img src='../images/filter.jpeg' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form71_header' onblur="form71_ini();"></th>
					<th>Description </th>
					<th>Balance </th>
