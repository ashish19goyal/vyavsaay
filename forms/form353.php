<div id='form353' class='tab-pane portlet box green-meadow'>
	...
	<div class='modal_forms'>
		<a href='#form353_modal_ndr' data-toggle="modal" id='form353_modal_ndr_link'></a>
		<div id="form353_modal_ndr" class="modal fade draggable-modal" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<form id='form353_modal_ndr_form'>
