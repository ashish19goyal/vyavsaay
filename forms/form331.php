<div id='form331' class='tab-pane portlet box green-meadow'>
	<div class="portlet-title">
		<div class='caption'>
			<div class='btn-group' id='form331_store' data-toggle='buttons' data-value='my'>
    ...
    <script>
        ...
        function form331_ini(store_type)
        {
            ...
            var paginator=$('#form331_body').paginator({func:"form331_ini($('#form331_store').data('value'))"});
            ...
            read_json_single_column(item_columns,function (items)
            {
                ...
                read_json_rows('form331',columns,function(results)
                {
					...
					vExport.export_buttons({action:'dynamic',columns:columns,file:'Inventory (without batch)',report_id:'form331',feach:function (item)
				    {
