		...
		<thead>
			<tr>
				<form id='form88_header'></form>
					<th>Product <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form88_header' onblur="form88_ini();"></th>
					<th>Process Notes </th>
					<th>Status <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form88_header' onblur="form88_ini();"></th>
					<th>Schedule</th>
