    ...
    <script>
        ...
        function form39_ini()
        {
			...
			read_json_rows('form39',columns,function(results)
			{
                                 	...
                                 	"<div class='caption'>"+
                                    	"<form id='form39_"+result.id+"'>"+
	                        			    ...
	                        			    "<input type='hidden' form='form39_"+result.id+"' name='id' value='"+result.id+"'>"+
																		"<input type='hidden' form='form39_"+result.id+"' name='indexes' value='"+result.indexes+"'>"+
	            			            "</form>"+
                                 	"</div>"+
                               	"</div>"+
                             "</div>";
				...
				vExport.export_buttons({action:'dynamic',columns:columns,file:'Products',report_id:'form39',feach:function (item)
				{
					delete item.indexes;
				}});
