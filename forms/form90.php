		...
		<div class="actions">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a id='form90_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
                    </li>
                    <li>
                      	<a id='form90_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
                    </li>
                    <li>
                        <a id='form90_print'><i class='fa fa-print'></i> Print</a>
                    </li>
                </ul>
            </div>
        </div>
	...
	<script>
		...
		function form90_ini()
		{
			...
			read_json_rows('form90',data_json,function(results)
			{
				...
				vExport.export_buttons({action:'dynamic',columns:data_json,file:'Invoice Types',report_id:'form90'});
				hide_loader();
			});
		};
