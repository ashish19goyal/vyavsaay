		...
		<div class="actions">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a id='form147_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
                    </li>
                    <li>
                      	<a id='form147_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
                    </li>
                    <li>
                        <a id='form147_print'><i class='fa fa-print'></i> Print</a>
                    </li>
                    <li class="divider"> </li>
                    <li>
                        <a id='form147_upload' onclick=modal23_action(form147_import_template,form147_import,form147_import_validate);><i class='fa fa-upload'></i> Import</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script>
        ...
        function form147_ini()
        {
            ...
            read_json_rows('form147',columns,function(results)
            {
				...
				vExport.export_buttons({action:'dynamic',columns:columns,file:'User Roles',report_id:'form147'});
				hide_loader();
            });
        };
