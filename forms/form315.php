		...
		<div class="actions">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a id='form315_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
                    </li>
                    <li>
                      	<a id='form315_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
                    </li>
                    <li>
                        <a id='form315_print'><i class='fa fa-print'></i> Print</a>
                    </li>
                </ul>
            </div>
      </div>
	...
	<script>
		...
		function form315_ini()
		{
			...
			read_json_rows('form315',other_data,function(results)
			{
				...
				vExport.export_buttons({action:'dynamic',columns:other_data,file:'Other Settings',report_id:'form315'});
				hide_loader();
			});
		};
