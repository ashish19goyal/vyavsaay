<div>
	...
	<script>
		function initialize_object_product_instances_sales(obj_name,obj_id)
		{
            var container=document.getElementById('object_product_instances_sales_body');
            container.innerHTML="";
            
            var paginator=$('#object_product_instances_sales_body').paginator(
                        {
                            page_size:5,
                            func:"initialize_object_product_instances_sales('"+obj_name+"','"+obj_id+"');"});
