<div>
    <div class='scroller' style='height:250px;' data-rail-visible1="1">
        <table class="table table-striped table-bordered table-hover dt-responsive no-more-tables" width="100%">
			<tbody id='object_staff_attributes'>
			</tbody>
		</table>
    </div>
	<script>
		function initialize_object_staff_attributes(obj_name,obj_id)
		{
            var container=document.getElementById('object_staff_attributes');
            container.innerHTML="";        
			var attribute_data={data_store:'attributes',
                           indexes:[{index:'id'},{index:'attribute'},{index:'value'},{index:'type',exact:'staff'},{index:'name',value:obj_name}]};
