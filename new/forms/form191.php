<div id='form191' class='tab-pane portlet box green-meadow'>	   
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='form191_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='form191_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='form191_print'><i class='fa fa-print'></i> Print</a>
      </div>	
	</div>
	...
	<script>
		...
		function form191_ini()
		{
			...
			read_json_rows('form191',pop_data,function(results)
			{
				...
				initialize_tabular_report_buttons(pop_data,'Values List','form191',function (item){});
				hide_loader();
			});
		};
