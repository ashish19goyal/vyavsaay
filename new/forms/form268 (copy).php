	...
	<div class="portlet-body">
        <form id='form268_master' autocomplete="off">
            <fieldset>
                ...
                <label><input type='text' name='awb_num' class='floatlabel' placeholder='Manual Challan #'></label>
...
////////////setting styles for containers/////////////////////////
	...
	info_section.setAttribute('style','width:100%;min-height:120px');
...
///////////////getting the content////////////////////////////////////////
	...
	business_contact.innerHTML="<hr style='border: 1px solid #000;'>Address: "+business_address+"<br>Contact Nos.: "+business_phone+"<br>E-Mail: "+business_email;
	...
	customer_info.innerHTML="<b>Customer: </b><br>"+customer_name+"<br>"+address+"<br>Date: "+date;
	business_info.innerHTML="<b>Seller</b><br>Challan No: "+challan_no+"<br>Prepared By: "+prepared_by+"<br>Narration: "+narration;
