<div id='form319' class='tab-pane portlet box green-meadow'>	   
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='form319_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='form319_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='form319_print'><i class='fa fa-print'></i> Print</a>
      </div>	
	</div>
			...
			<thead>
				<tr>
					<form id='form319_header'></form>
						...
						<th><input type='text' placeholder="Elements" class='floatlabel' name='elements' form='form319_header'></th>
					...
					var rowsHTML="<tr>";
						rowsHTML+="<form id='form319_"+result.id+"'></form>";
							...
							rowsHTML+="<td data-th='Elements'>";
								rowsHTML+="<textarea class='dblclick_editable' readonly='readonly' form='form319_"+result.id+"'>"+result.elements+"</textarea>";
							rowsHTML+="</td>";
