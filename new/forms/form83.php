<div id='form83' class='tab-pane portlet box yellow-saffron'>
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='form83_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='form83_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='form83_print'><i class='fa fa-print'></i> Print</a>
      </div>	
	</div>
