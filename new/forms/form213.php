		...
		<thead>
			<tr>
				<form id='form213_header'></form>
					...
					<th>Details </th>
					<th>Followup Date</th>
					<th>Identified By/PoC <img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form213_header'></th>
