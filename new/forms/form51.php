								...
								var rowsHTML="<tr>";
									rowsHTML+="<form id='form51_"+data_id+"' class='save_form51'></form>";
										rowsHTML+="<td data-th='Name'>";
											rowsHTML+="<textarea readonly='readonly' class='dblclick_editable' title='"+element.element_id+"' form='form51_"+data_id+"'>"+element.element_name+"</textarea>";
										rowsHTML+="</td>";
						...
						results.forEach(function(result)
						{
							...
							var rowsHTML="<tr>";
								rowsHTML+="<form id='form51_"+result.id+"' class='save_form51'></form>";
									rowsHTML+="<td data-th='Name'>";
										rowsHTML+="<textarea readonly='readonly' form='form51_"+result.id+"'>"+result.element_name+"</textarea>";
									rowsHTML+="</td>";
									rowsHTML+="<td data-th='Read'>";
			...
			if(is_create_access('form51'))
			{
				...
				var rowsHTML="<tr>";
					rowsHTML+="<form id='form51_"+id+"' class='save_form51'></form>";
						rowsHTML+="<td data-th='Name'>";
							rowsHTML+="<input type='text' form='form51_"+id+"'>";
						rowsHTML+="</td>";
						rowsHTML+="<td data-th='Read'>";
						...
						rowsHTML+="<td data-th='Action'>";
							...
							rowsHTML+="<input type='hidden' form='form51_"+id+"' required name='element_id'>";
