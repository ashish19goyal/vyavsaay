<div id='form320' class='tab-pane'>
	<form id='form320_master' autocomplete="off">
		<fieldset>
			...
			<label>	<input type='button' title='Print Bill' class='print_icon' onclick='form320_print_form();'></label>
	...
	<table class='rwd-table'>
		<thead>
			<tr>
				<form id='form320_header'></form>
					<th>Item</th>
					<th>Quantity</th>
					<th>Pricing</th>
					<th><input type='button' form='form320_header' title='Add item' class='add_icon' onclick='form320_add_item();'></th>
			</tr>
		</thead>
		<tbody id='form320_body'>
		</tbody>
		<tfoot id='form320_foot'>
		</tfoot>
	</table>
	
	<script>
	  function form320_header_ini()
		{
			var fields=document.getElementById('form320_master');
			...
			var add_customer=document.getElementById('form320_add_customer');
			...
			var order_num_data="<user_preferences count='1'>"+
						...
						"</user_preferences>";
			get_single_column_data(function (onums) 
			{
				if(onums.length>0)
				{
					order_num_filter.value=get_session_var('so_prefix')+"-"+onums[0];
				}
			},order_num_data);			
		...
		function form320_ini()
		{
			var order_id=$("#form320_link").attr('data_id');
			if(order_id==null)
				order_id="";	
			...
			if(order_id!="")
			{
				...
				fetch_requested_data('',order_columns,function(order_results)
				{
					...
					{
						var filter_fields=document.getElementById('form320_master');
				...
				/////////////////////////////////////////////////////////////////////////
					...
					fetch_requested_data('',order_items_column,function(results)
					{
						results.forEach(function(result)
						{
							...
							var id=result.id;
							rowsHTML+="<tr>";
							rowsHTML+="<form id='form320_"+id+"'></form>";
								rowsHTML+="<td data-th='Item'>";
									rowsHTML+="<input type='text' class='wideinput' readonly='readonly' required form='form320_"+id+"' value='"+result.item_name+"'>";
									rowsHTML+="<br><textarea readonly='readonly' form='form320_"+id+"'>"+result.item_desc+"</textarea>";
								rowsHTML+="</td>";
								rowsHTML+="<td data-th='Quantity'>";
									rowsHTML+="<input type='number' class='dblclick_editable' readonly='readonly' required form='form320_"+id+"' value='"+result.quantity+"'>";
								rowsHTML+="</td>";
								rowsHTML+="<td data-th='Price'>";
									rowsHTML+="Price: <input type='number' readonly='readonly' form='form320_"+id+"' value='"+result.unit_price+"' step='any'>";
									rowsHTML+="<br>MRP: <input type='number' readonly='readonly' form='form320_"+id+"' value='"+result.mrp+"' step='any'>";
									rowsHTML+="<br>Amount: <input type='number' readonly='readonly' form='form320_"+id+"' value='"+result.amount+"' step='any'>";
									rowsHTML+="<br>Tax: <input type='number' readonly='readonly' form='form320_"+id+"' value='"+result.tax+"' step='any'>";
								rowsHTML+="</td>";
								rowsHTML+="<td data-th='Action'>";
									rowsHTML+="<input type='hidden' form='form320_"+id+"' value='"+result.total+"'>";
									rowsHTML+="<input type='hidden' form='form320_"+id+"' value='"+id+"'>";
									rowsHTML+="<input type='button' class='submit_hidden' form='form320_"+id+"' id='save_form320_"+id+"'>";
									rowsHTML+="<input type='button' class='delete_icon' form='form320_"+id+"' id='delete_form320_"+id+"' onclick='form320_delete_item($(this));'>";
								rowsHTML+="</td>";			
							rowsHTML+="</tr>";
						
							$('#form320_body').append(rowsHTML);					
						});
						form320_get_totals();
						$('textarea').autosize();
						hide_loader();
		...
		function form320_add_item()
		{
			if(is_create_access('form320'))
			{
				...
				rowsHTML+="<form id='form320_"+id+"' autocomplete='off'></form>";
					rowsHTML+="<td data-th='Item'>";
						rowsHTML+="<input type='text' placeholder='Item' required form='form320_"+id+"' value=''>";
						rowsHTML+="<br><textarea required placeholder='Name' form='form320_"+id+"'></textarea>";
					rowsHTML+="</td>";
					rowsHTML+="<td data-th='Quantity'>";
						rowsHTML+="<input type='number' required form='form320_"+id+"' value='' step='any'>";
					rowsHTML+="</td>";
					rowsHTML+="<td data-th='Notes'>";
						rowsHTML+="Price: <input type='number' readonly='readonly' class='dblclick_editable' form='form320_"+id+"' step='any'>";
						rowsHTML+="<br>MRP: <input type='number' readonly='readonly' class='dblclick_editable' form='form320_"+id+"' step='any'>";
						rowsHTML+="<br>Amount: <input type='number' readonly='readonly' form='form320_"+id+"' step='any'>";
						rowsHTML+="<br>Tax: <input type='number' readonly='readonly' form='form320_"+id+"' step='any'>";
					rowsHTML+="</td>";
					rowsHTML+="<td data-th='Action'>";
						rowsHTML+="<input type='hidden' form='form320_"+id+"' name='total'>";
						rowsHTML+="<input type='hidden' form='form320_"+id+"' value='"+id+"'>";
						rowsHTML+="<input type='button' class='submit_hidden' form='form320_"+id+"' id='save_form320_"+id+"' >";
						rowsHTML+="<input type='button' class='delete_icon' form='form320_"+id+"' id='delete_form320_"+id+"' onclick='$(this).parent().parent().remove(); form320_get_totals();'>";
						rowsHTML+="<input type='submit' class='submit_hidden' form='form320_"+id+"'>";
						rowsHTML+="<input type='hidden' form='form320_"+id+"' name='tax_rate'>";
					rowsHTML+="</td>";			
				rowsHTML+="</tr>";
			
				$('#form320_body').prepend(rowsHTML);
				
				var filter_fields=document.getElementById('form320_master');
				var bill_type=filter_fields.elements['bill_type'].value;
			
				var fields=document.getElementById("form320_"+id);
		...
		function form320_create_item(form)
		{
			if(is_create_access('form320'))
			{
				var order_id=document.getElementById("form320_master").elements['order_id'].value;
				var order_status=document.getElementById("form320_master").elements['status'].value;
				...
				{
					form320_delete_item(del_button);
				});
		...
		function form320_create_form()
		{
			if(is_create_access('form320'))
			{
				...
				$("[id^='save_form320']").each(function(index)
				{
		...
		function form320_update_form()
		{
			if(is_update_access('form320'))
			{
				var form=document.getElementById("form320_master");
		...
		function form320_delete_item(button)
		{
			if(is_delete_access('form320'))
			{
		...
		function form320_print_form()
		{	
			print_form320(function(container)
			{
				$.print(container);
				container.innerHTML="";	
			});	
