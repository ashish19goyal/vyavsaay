		...
		<thead>
			<tr>
				<form id='form115_header'></form>
					...
					<th>Item<img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form115_header'></th>
					<th>Quantity</th>
					<th>Total</th>
					<th>Status<img src='../images/filter.png' class='filter_icon' onclick='show_filter($(this));'><input type='text' class='filter' form='form115_header'></th>
