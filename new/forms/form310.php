<div id='form310' class='tab-pane portlet box green-meadow'>	   
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='form310_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='form310_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='form310_print'><i class='fa fa-print'></i> Print</a>
      </div>	
	</div>
	...
	<script>
		...
		function form310_ini()
		{
			...
			read_json_rows('form310',pop_data,function(results)
			{
				...
				initialize_tabular_report_buttons(pop_data,'Values List','form310',function (item){});
				hide_loader();
			});
		};
