<div id='form276' class='tab-pane portlet box green-meadow'>	   
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='form276_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='form276_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='form276_print'><i class='fa fa-print'></i> Print</a>
      </div>	
	</div>
	...
	<script>
		...
		function form276_ini()
		{
			...
			{	
				...
				initialize_tabular_report_buttons(new_columns,'Search Settings','form276',function (item){});
				hide_loader();
			});
		}
