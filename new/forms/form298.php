<div id='form298' class='tab-pane portlet box green-meadow'>	   
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='form298_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='form298_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='form298_print'><i class='fa fa-print'></i> Print</a>
      </div>	
	</div>
	...
	<script>
		...
		function form298_ini()
		{
			...
			read_json_rows('form298',overwrite_data,function(results)
			{
				...
				initialize_tabular_report_buttons(overwrite_data,'Newsletter Components','form298',function (item){});
				hide_loader();
			});
		};
