<div id='form317' class='tab-pane portlet box green-meadow'>	   
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='form317_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='form317_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='form317_print'><i class='fa fa-print'></i> Print</a>
      </div>	
	</div>
	...
	<script>
		...
		function form317_ini()
		{
			...
			read_json_rows('form317',other_data,function(results)
			{
				...
				initialize_tabular_report_buttons(other_data,'Form Tabs','form317',function (item){});
				hide_loader();
			});
		};
