        ...
        function form269_ini()
        {
            ...
            read_json_rows('form269',new_columns,function(results)
            {
                    ...
                    var rowsHTML="<tr>";
                        rowsHTML+="<form id='form269_"+result.id+"'></form>";
                            ...
                            rowsHTML+="<td data-th='Details'>";
                                rowsHTML+="<input type='text' class='floatlabel' placeholder='Type' readonly='readonly' form='form269_"+result.id+"' value='"+result.type+"'>";
								rowsHTML+="<input type='text' class='floatlabel' placeholder='Prepared By' readonly='readonly' form='form269_"+result.id+"' value='"+result.prepared_by+"'>";
								rowsHTML+="<input type='text' class='floatlabel' placeholder='Manual Challan #' readonly='readonly' form='form269_"+result.id+"' value='"+result.awb_num+"'>";
								rowsHTML+="<input type='text' class='floatlabel' placeholder='Vehicle #' readonly='readonly' form='form269_"+result.id+"' value='"+result.vehicle_num+"'>";
							rowsHTML+="</td>";
				...
				initialize_tabular_report_buttons(new_columns,'Delivery Challans','form269',function (item)
                {
                    ...
                    item['Manual Challan #']=get_my_past_date(item.awb_num);
