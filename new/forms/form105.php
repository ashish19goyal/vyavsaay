<div id='form105' class='tab-pane'>
	<form id='form105_master' autocomplete="off">
		<fieldset>
			...
			<label> <input type='submit' title='Save' class='submit_hidden'></label>
			<label>	<input type='button' title='Save' class='save_icon' onclick='form105_create_form();'></label>	
		</fieldset>
	</form>
