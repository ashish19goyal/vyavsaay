<div id='form105' class='tab-pane portlet box green-meadow'>	   
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='form105_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='form105_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='form105_print'><i class='fa fa-print'></i> Print</a>
      </div>	
	</div>
