...
function form51_add_item()
{
	if(is_create_access('form51'))
	{
		...
		var rowsHTML="<tr>";
			rowsHTML+="<form id='form51_"+id+"'></form>";
				...
				rowsHTML+="<td data-th='Action'>";
					...
					rowsHTML+="<input type='hidden' form='form51_"+id+"' name='element_id'>";
					rowsHTML+="<input type='submit' class='save_icon' id='save_form51_"+id+"' form='form51_"+id+"'>";	
				rowsHTML+="</td>";			
		rowsHTML+="</tr>";
		...
		var names_data="<user_preferences>" +
				"<display_name></display_name>" +
				"</user_preferences>";
		set_my_value_list(names_data,name_filter,function () 
		{
			$(name_filter).focus();
		});
...
function form136_add_item()
{
	if(is_create_access('form136'))
	{
		...
		rowsHTML+="<form id='form136_"+id+"' autocomplete='off'></form>";
			...
			rowsHTML+="</td>";
			rowsHTML+="<td data-th='Bill Price'>";
				rowsHTML+="<b>Unit Price</b>: <input type='number' form='form136_"+id+"' step='any'>";
				rowsHTML+="<br><b>Amount</b>: <input type='number' readonly='readonly' form='form136_"+id+"' value='' step='any'>";
				rowsHTML+="<br><b>Tax</b>: <input type='number' required form='form136_"+id+"' step='any'>";
			rowsHTML+="</td>";
			rowsHTML+="<td data-th='PO Price'>";
				rowsHTML+="<b>Unit Price</b>: <input type='number' readonly='readonly' form='form136_"+id+"' step='any'>";
				rowsHTML+="<br><b>Amount</b>: <input type='number' readonly='readonly' form='form136_"+id+"' value='' step='any'>";
				rowsHTML+="<br><b>Tax</b>: <input type='number' readonly='readonly' required form='form136_"+id+"' step='any'>";
			rowsHTML+="</td>";
		...
		var rowsHTML="<tr>";
			rowsHTML+="<form id='form148_"+id+"'></form>";
				...
				rowsHTML+="<td data-th='Action'>";
					...
					rowsHTML+="<input type='hidden' form='form148_"+id+"' name='element_id'>";
					rowsHTML+="<input type='submit' class='save_icon' id='save_form148_"+id+"' form='form148_"+id+"'>";	
				rowsHTML+="</td>";			
		rowsHTML+="</tr>";
