				...
				rowsHTML+="<tr>";
					rowsHTML+="<form id='form39_"+result.id+"'></form>";
						...
						rowsHTML+="<td data-th='Picture'>";
							...
							rowsHTML+="<input type='file' style='display:none' form='form39_"+result.id+"'>";
							rowsHTML+="<input type='button' class='generic_red_icon' form='form39_"+result.id+"' value='Change Picture'>";
						rowsHTML+="</td>";
...
function form44_ini()
{
	...
	{	
		results.forEach(function(result)
		{
			...
			rowsHTML+="<tr>";
				rowsHTML+="<form id='form44_"+result.id+"'></form>";
					rowsHTML+="<td data-th='Name'>";
						rowsHTML+="<textarea class='input_link widebox' onclick=\"element_display('"+result.id+"','form2',['form233','form299']);\" readonly='readonly' form='form44_"+result.id+"'>"+result.name+"</textarea>";
					rowsHTML+="</td>";
					rowsHTML+="<td data-th='Description'>";
						rowsHTML+="<textarea readonly='readonly' class='dblclick_editable' class='widebox' form='form44_"+result.id+"'>"+result.description+"</textarea>";
					rowsHTML+="</td>";
					rowsHTML+="<td data-th='Status'>";
					...
					rowsHTML+="<td data-th='Action'>";
						...
						rowsHTML+="<input type='submit' class='save_icon' form='form44_"+result.id+"' title='Save'>";
		...
		$(export_button).on("click", function(event)
		{
			get_limited_export_data(new_columns,'Newsletters',function(new_result)
			{
			});
		});
		hide_loader();
...
function form96_ini()
{
	...
	read_json_rows('form96',new_columns,function(results)
	{
		...
		$(export_button).on("click", function(event)
		{
			get_limited_export_data(new_columns,'Customer Attributes',function(new_result)
			{
			});
		});
		hide_loader();
		...
		{	
			results.forEach(function(result)
			{
				...
				if(read)
				{
					...
					{
						class_string="class='cancelled_row'";					
					}
					else if(result.applicable_from!="" && (result.applicable_from<get_my_time()))
					{
						class_string="class='red_row'";
					}
					var rowsHTML="";
						rowsHTML+="<tr "+class_string+">";
							rowsHTML+="<form id='form145_"+result.id+"'></form>";
								...
								rowsHTML+="<td data-th='Store'>";
									rowsHTML+="<b>Source</b>: <input type='text' readonly='readonly' form='form145_"+result.id+"' value='"+result.source+"'>";
									rowsHTML+="<br><b>Target</b>: <input type='text' readonly='readonly' form='form145_"+result.id+"' value='"+result.target+"'>";
								rowsHTML+="</td>";
								rowsHTML+="<td data-th='Status'>";
									rowsHTML+="<input type='text' readonly='readonly' form='form145_"+result.id+"' value='"+result.status+"'>";
									rowsHTML+="<br><b>Scheduled for</b>: <input type='text' readonly='readonly' form='form145_"+result.id+"' value='"+get_my_datetime(result.applicable_from)+"'>";
								rowsHTML+="</td>";
								rowsHTML+="<td data-th='Action'>";
...
function form239_ini()
{
	...
	{	
		results.forEach(function(result)
		{
			...
			rowsHTML+="<tr>";
				rowsHTML+="<form id='form239_"+result.id+"'></form>";
					rowsHTML+="<td data-th='Item'>";
						rowsHTML+="<input type='text' readonly='readonly' form='form239_"+result.id+"' class='input_link' value='"+result.name+"' onclick=\"element_display('"+result.id+"','form240');\">";
					rowsHTML+="</td>";
		...
		$(export_button).on("click", function(event)
		{
			get_export_data(columns,'Item Production Requirements');
		});
		hide_loader();
	});
}
			...
			rowsHTML+="<tr>";
				rowsHTML+="<form id='form243_"+result.id+"'></form>";
					...
					rowsHTML+="<td data-th='Action'>";
						...
						rowsHTML+="<input type='button' form='form243_"+result.id+"' value='Email Receipt' class='share_icon'>";
					rowsHTML+="</td>";				
			rowsHTML+="</tr>";
...
function form282_ini()
{
	...
	////indexing///
	var index_element=document.getElementById('form282_index');
	var prev_element=document.getElementById('form282_prev');
	var next_element=document.getElementById('form282_next');
	var start_index=index_element.getAttribute('data-index');
	//////////////
	...
	fetch_requested_data('form282',columns,function(results)
	{
		results.forEach(function(result)
		{
			var rowsHTML="";
			rowsHTML+="<tr>";
				rowsHTML+="<form id='form282_"+result.id+"'></form>";
					...
					rowsHTML+="</td>";
					rowsHTML+="<td data-th='Action'>";
						rowsHTML+="<input type='button' form='form282_"+result.id+"' value='Add document' class='generic_icon'>";
					rowsHTML+="</td>";				
			rowsHTML+="</tr>";
			...
			var doc_column="<documents>" +
							...
							"<target_id exact='yes'>"+result.id+"</target_id>" +
							"</documents>";
			fetch_requested_data('form282',doc_column,function(doc_results)
			{
				var docHTML="";
				for (var j in doc_results)
				{
		...
		$(export_button).on("click", function(event)
		{
			get_export_data(columns,'Payable Receipts');
		});
		hide_loader();
	});
};
