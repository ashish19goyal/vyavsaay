<div>
    <div class='scroller' style='height:250px;' data-rail-visible1="1">
        <table class="table table-striped table-bordered table-hover dt-responsive no-more-tables" width="100%">
			...
			<tbody id='object_suppliers_score_body'>
			</tbody>
            <tfoot id='object_suppliers_score_foot'>
			</tfoot>
		</table>
    </div>
	<script>
		function initialize_object_suppliers_score(obj_name,obj_id)
		{
            var container=document.getElementById('object_suppliers_score_body');
            container.innerHTML="";
                    ...
                    read_json_rows('',fields_data,function (fields) 
                    {
                        ...
                        read_json_rows('',field_value_data,function (field_values) 
                        {
                            ...
                            for(var i=1;i<fields.length;i++)
                            {
                                ...
                                $('#object_suppliers_score_body').append(rowsHTML);
                            }
                            ...
                            $('#object_suppliers_score_foot').html(footHTML);
                        });
                    });
                }
            });
