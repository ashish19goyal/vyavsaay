<div>
    <div class='row'>
        <div class="col-md-12 col-sm-12">
            <div id="object_staff_tasks_calendar" class="has-toolbar"></div>
        </div>
    </div>
	<script>
		function initialize_object_staff_tasks(obj_name,obj_id)
		{
            $('#object_staff_tasks_calendar').fullCalendar('destroy');
            $('#object_staff_tasks_calendar').fullCalendar(
            {
                header: {
                    left: 'prev,next',
                    center: 'title',
