<div id='report82' class='tab-pane portlet box red-sunglo'>	   
	<div class="portlet-title">
		...
		<div class="actions">
      	<a class='btn btn-default btn-sm' id='report82_csv'><i class='fa fa-file-excel-o'></i> Save as CSV</a>
      	<a class='btn btn-default btn-sm' id='report82_pdf'><i class='fa fa-file-pdf-o'></i> Save as PDF</a>
      	<a class='btn btn-default btn-sm' id='report82_print'><i class='fa fa-print'></i> Print</a>
      	<a class='btn btn-default btn-sm' id='report82_email'><i class='fa fa-envelope'></i> Email</a>
     </div>	
	</div>
