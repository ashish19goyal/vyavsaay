<div id='report58' class='tab-pane portlet box red-sunglo'>
	<div class="portlet-title">
		<div class='caption'>
			...
			<a class='btn btn-circle grey btn-outline btn-sm' onclick='report58_popup_action();'>Add Entry</a>
		</div>
		<div class="actions">
            <div class="btn-group">
	...
	<div class='modal_forms'>
		<a href='#report58_popup' data-toggle="modal" id='report58_popup_link'></a>
		<div id="report58_popup" class="modal fade draggable-modal" role="basic" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<form id='report58_popup_form' autocomplete="off">
			               ...
			               <div class="scroller" style="height:50%;" data-always-visible="1" data-rail-visible1="1">
							   <div class="row">
									<div class="col-sm-12 col-md-4">Type</div>
						     		<div class="col-sm-12 col-md-8"><input type='text' form='report58_popup_form' name='type' required></textarea></div>
						       </div>
							   <div class="row">
 									<div class="col-sm-12 col-md-4">Date</div>
 					     			<div class="col-sm-12 col-md-8"><input type='text' required form='report58_popup_form' name='date'></div>
 						      </div>
 			                  <div class="row">
									<div class="col-sm-12 col-md-4">Account</div>
					     			<div class="col-sm-12 col-md-8"><input type='text' required form='report58_popup_form' name='account'></div>
						      </div>
			                  <div class="row">
									<div class="col-sm-12 col-md-4">Narration</div>
	                              	<div class="col-sm-12 col-md-8"><textarea required form='report58_popup_form' name='narration'></textarea></div>
						       </div>
						       <div class="row">
									<div class="col-sm-12 col-md-4">Amount</div>
						     		<div class="col-sm-12 col-md-8"><input type='number' step='any' form='report58_popup_form' name='amount' required></div>
						       </div>
							   <div class="row">
									<div class="col-sm-12 col-md-4">Balance</div>
						     		<div class="col-sm-12 col-md-8"><input type='text' readonly='readonly' form='report58_popup_form' name='balance'></div>
						       </div>
			               </div>
			             </div>
						<div class="modal-footer">
							<button type="submit" class="btn green" form='report58_popup_form' name='save'>Add</button>
							<button type="button" data-dismiss='modal' class="btn red" form='report58_popup_form' name='cancel'>Cancel</button>
						</div>
					</form>
				</div>
			</div>
	...
	<script>
              ...
              transactions.forEach(function(tran)
              {
				  ...
				  rowsHTML+="<td data-th='Balance'>";
				  		if(tran.source=='manual entry')
                        	rowsHTML+="<button type='button' class='btn red' name='delete' title='Delete' onclick=\"report58_delete_item($(this),'"+tran.id+"');\"><i class='fa fa-trash'></i></button>";
                  rowsHTML+="</td>";
				  rowsHTML+="</tr>";
		...
		function report58_delete_item(button,data_id)
		{
			if(is_delete_access('report58'))
			{
		...
		function report58_popup_action()
		{
			var form=document.getElementById("report58_popup_form");
			...
			vUtil.onChange(account_filter,function()
			{
				...
				read_json_rows('report58',transactions_data,function(transactions)
				{
