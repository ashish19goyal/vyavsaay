...
/*rewrite this function to be able to retain the original ids and structure*/
function tabsToAccordions()
{
	$(".tabs").each(function(){
		var e=$("<div class='accordion function_main' id='"+$(this).attr('id')+"'>");
		var t=new Array;
...
function accordionsToTabs()
{
	...
	{
		var e=$("<div class='tabs function_main' id='"+$(this).attr('id')+"'>");
		var n=$("<ul>");
