				...
				if(read)
				{
					...
					rowsHTML+="<form id='form137_"+id+"'></form>";
						rowsHTML+="<td data-th='Project Code'>";
							rowsHTML+="<textarea readonly='readonly' form='form137_"+id+"'>"+result.name+"</textarea>";
						rowsHTML+="</td>";
						rowsHTML+="<td data-th='Person'>";
...
function form139_ini()
{
	...
	fetch_requested_data('form139',member_columns,function(results)
	{
		...
		rowsHTML+="<form id='form139_"+id+"'></form>";
			...
			rowsHTML+="</td>";
			rowsHTML+="<td data-th='Notes'>";
				rowsHTML+="<textarea readonly='readonly' class='dblclick_editable' form='form139_"+id+"'>"+result.notes+"</textarea>";
			rowsHTML+="</td>";
			rowsHTML+="<td data-th='Action'>";
