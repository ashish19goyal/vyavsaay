						...
						rowsHTML+="<form id='form101_"+result.id+"'></form>";
							...
							rowsHTML+="<td data-th='Action'>";
								...
								if(result.status=='active')
								{
									...
									rowsHTML+="<input type='button' class='generic_icon' form='form101_"+result.id+"' value='Schedule' onclick=\"element_display('"+result.id+"','form138');\">";
									...
									rowsHTML+="<input type='button' class='generic_icon' form='form101_"+result.id+"' value='Expenses' onclick=\"element_display('"+result.id+"','form137');\">";
								}
							rowsHTML+="</td>";			
					rowsHTML+="</tr>";
				...
				results.forEach(function(result)
				{
					...
					rowsHTML+="<form id='form119_"+id+"'></form>";
						rowsHTML+="<td data-th='Product Name'>";
							...
							rowsHTML+="<br><textarea required form='form119_"+id+"' readonly='readonly'>"+result.item_name+"</textarea>";
						rowsHTML+="</td>";
						rowsHTML+="<td data-th='Batch'>";
						...
						rowsHTML+="<td data-th='Quantity'>";
							...
							rowsHTML+="<br><v1>Free: </v1><input type='number' min='0' value='0' required form='form119_"+id+"' readonly='readonly' step='any' value='"+result.f_quantity+"'>";
						rowsHTML+="</td>";
						rowsHTML+="<td data-th='Price'>";
							...
							rowsHTML+="<br><v1>MRP: </v1>Rs. <input type='number' min='0' readonly='readonly' form='form119_"+id+"' step='any' value='"+result.mrp+"'>";
						rowsHTML+="</td>";
						rowsHTML+="<td data-th='Total'>";
