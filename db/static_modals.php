...
*@*box_content*:*
*/
<a href='#modal89' data-toggle="modal" id='modal89_link'></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form id='modal89_form'>
				...
				<div class="modal-body">
					<div class="scroller" style="height:100px;" data-always-visible="1" data-rail-visible1="1">
						Challan could not be generated as none of the items were found deliverable.
					</div>
				</div>
				<div class="modal-footer">
					<input type="button" class="btn green" data-dismiss='modal' name='close' value='Ok'>
...
/*box_id*:*modal90
*@*box_title*:*Partial Challan Not Allowed
*@*box_type*:*static
*@*function_name*:*
*@*function_def*:*
*@*status*:*active
...
*@*box_content*:*
*/
<a href='#modal90' data-toggle="modal" id='modal90_link'></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form id='modal90_form'>
				...
				<div class="modal-body">
					<div class="scroller" style="height:100px;" data-always-visible="1" data-rail-visible1="1">
						Challan could not be generated as partial delivery of items is disabled.
					</div>
				</div>
				<div class="modal-footer">
					<input type="button" class="btn green" data-dismiss='modal' name='close' value='Ok'>
...
/*box_id*:*modal91
*@*box_title*:*No Composition record
*@*box_type*:*static
*@*function_name*:*
*@*function_def*:*
*@*status*:*active
...
*@*box_content*:*
*/
<a href='#modal91' data-toggle="modal" id='modal91_link'></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form id='modal91_form'>
				...
				<div class="modal-body">
					<div class="scroller" style="height:100px;" data-always-visible="1" data-rail-visible1="1">
						No composition records were found for this product.
					</div>
				</div>
				<div class="modal-footer">
					<input type="button" class="btn green" data-dismiss='modal' name='close' value='Ok'>
...
*@*box_content*:*
*/
<a href='#modal92' data-toggle="modal" id='modal92_link'></a>
...
*@*box_content*:*
*/
<a href='#modal93' data-toggle="modal" id='modal93_link'></a>
...
/*box_id*:*modal94
*@*box_title*:*Configuration Updated
*@*box_type*:*static
*@*function_name*:*
*@*function_def*:*
*@*status*:*active
...
*@*box_content*:*
*/
<a href='#modal94' data-toggle="modal" id='modal94_link'></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form id='modal94_form'>
				...
				<div class="modal-body">
					<div class="scroller" style="height:100px;" data-always-visible="1" data-rail-visible1="1">
						System configurations have been updated. Please clear browser cache for changes to reflect.
					</div>
				</div>
				<div class="modal-footer">
					<input type="button" class="btn green" data-dismiss='modal' name='close' value='Ok'>
...
*@*box_content*:*
*/
<a href='#modal98' data-toggle="modal" id='modal98_link'></a>
<div id="modal98" class="modal fade draggable-modal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id='modal98_form'>
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title">Cannot Delete Record</h4>
				</div>
				<div class="modal-body">
					<div class="scroller" style="height:100px;" data-always-visible="1" data-rail-visible1="1">
						This record cannot be deleted, as some transactions exist against it.
					</div>
				</div>
				<div class="modal-footer">
					<input type="button" class="btn green" data-dismiss='modal' name='close' value='Ok'>
