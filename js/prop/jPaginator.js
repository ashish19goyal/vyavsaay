...
(function ($) {
	var Paginator = function (element,options) 
	{
		...
		var html_content="<div "+hide+" class='pagination-panel'>"+
								"<a class='btn btn-sm grey-mint prev disabled' id='"+settings.binding_id+"_prev' data-index='-"+settings.page_size+"' onclick=\"$('#"+settings.binding_id+"_index').attr('data-index',$(this).attr('data-index'));;"+settings.func+"\"><i class='fa fa-angle-left'></i></a>"+
								...
								"<a class='btn btn-sm grey-mint next' id='"+settings.binding_id+"_next' data-index='"+settings.page_size+"' onclick=\"$('#"+settings.binding_id+"_index').attr('data-index',$(this).attr('data-index'));"+settings.func+"\"><i class='fa fa-angle-right'></i></a>"+
							"</div>";
